...
def main():
    ...
    # HR images
    opt['input_folder'] = '/home/data/OCT_data/Paired_dataset/varied_resol/hr'
    opt['save_folder'] = '/home/data/OCT_data/Paired_dataset/varied_resol/hr_sub'
    opt['crop_size'] = 480
    opt['step'] = 240
    opt['thresh_size'] = 0
    ...
    # LRx2 images
    opt['input_folder'] = '/home/data/OCT_data/Paired_dataset/varied_resol/lr'
    opt['save_folder'] = '/home/data/OCT_data/Paired_dataset/varied_resol/lr_sub'
    opt['crop_size'] = 240
    opt['step'] = 120
    opt['thresh_size'] = 0
    extract_subimages(opt)
